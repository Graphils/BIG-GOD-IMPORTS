        ...
        <div className="container navbar-inner">
          ...
          <nav className={`navbar-links${menuOpen ? ' open' : ''}`}>
            ...
            <div className="mobile-menu-extras">
              <button className="mobile-menu-btn" onClick={() => { setSearchOpen(s => !s); setMenuOpen(false); }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
                Search
              </button>
              <button className="mobile-menu-btn" onClick={() => setDark(d => !d)}>
                {dark ? (
          ...
          <div className="navbar-actions">
            ...
            {user ? (
              ...
              <Link to="/login" className="signin-btn" aria-label="Sign in" onClick={() => setMenuOpen(false)}>
