...
export default function PaymentCallback() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-page)', padding: '40px 24px' }}>
      <div style={{ background: 'var(--bg-card)', borderRadius: 'var(--radius-md)', padding: '60px 48px', textAlign: 'center', maxWidth: '480px', width: '100%', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-md)' }}>
        {status === 'verifying' && (
          <>
            <div className="spinner" />
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '28px', color: 'var(--text-heading)', marginBottom: '12px' }}>Verifying Payment</h2>
        ...
        {status === 'success' && (
          <>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '32px', color: 'var(--text-heading)', marginBottom: '12px' }}>Payment Successful!</h2>
        ...
        {status === 'failed' && (
          <>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '32px', color: 'var(--text-heading)', marginBottom: '12px' }}>Payment Failed</h2>
            <p style={{ color: 'var(--text-mid)', lineHeight: '1.7', marginBottom: '28px' }}>
